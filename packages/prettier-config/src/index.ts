import type { Options as PackageJSONOptions } from '@simbashrd/prettier-plugin-package-json'
...
const simbashrd = (options: Options = {}): Options => {
  ...
  return {
    ...
    plugins: [
      ...
      '@simbashrd/prettier-plugin-package-json',
      ...plugins,
