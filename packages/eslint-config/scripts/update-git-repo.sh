...
git clone --depth 1 --single-branch --branch main https://github.com/honghong.me/eslint-config-inspector.git
...
This is a ESLint config inspector generated by [@simbashrd/eslint-config](https://github.com/lucaimbalzano/lucaimbalzano.io/tree/main/packages/eslint-config)
EOF
...
git push git@github.com:simbashrd/eslint-config-inspector.git main -f
