...
import { ScrollSentences } from '@simbashrd/ui'
...
const scrollSentences: SentenceProps[] = [
  { sentence: 'For where your treasure is, there your heart will be also. ' },
  { sentence: '🫀' },
  { sentence: 'Above all else, guard your heart, for everything you do flows from it.' },
  { sentence: '❤️‍🔥' }
]
  ...
  return (
    <>
      ...
      <div className='m-5 p-8'>
        <ScrollSentences sentence={scrollSentences} textSize='text-2xl' />
      </div>
      <SelectedProjects />
      <AboutMe />
      <LatestArticles />
